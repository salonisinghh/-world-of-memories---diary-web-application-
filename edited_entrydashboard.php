...
// Fetch edited entries
$sql = "SELECT id, title, date FROM edited_entries WHERE email = ? ORDER BY date DESC";
...
<head>
    ...
    margin: 0;
    padding: 0;
    background:background:linear-gradient(135deg,rgb(223, 194, 227),rgb(225, 158, 237));
}
.navbar {
    display: flex;
...
<body>
    <div class="navbar">
        <h1>W<img src="logo1.webp" style="height:50px;width:50px;border-radius:50px;">rld of Memories</h1>
        <div class="user-menu">
            ...
            <div class="dropdown">
                <div class="dropdown-item">
                    ...
                    <div class="account-dropdown">
                        ...
                        <a onclick="return confirm('Are you sure? This action cannot be undone.')" href="delete_account.php">Delete Account</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <h2 style="text-align:center;">Your Edited Memories</h2>
    ...
    <div id="entriesContainer">
        <?php foreach ($entries as $row): ?>
            <div class="entry" data-title="<?php echo strtolower(htmlspecialchars($row['title'])); ?>">
                ...
                <a class="btn" href="view_edited_entry.php?id=<?php echo $row['id']; ?>">Open</a>
                <a class="btn btn-delete" href="delete_edited_entry.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this edited memory?');">Delete</a>
            </div>
        <?php endforeach; ?>
    </div>
